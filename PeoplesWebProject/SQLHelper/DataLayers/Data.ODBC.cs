...
namespace UCGuideSQLHelper.ODBC
{
    public class OdbcAccess : DataAccess
    {
        ...
        {
            return base._getCommand<OdbcCommand>(ref sqlCommand, cmdType);
        }
        ...
        public override DataTable GetData(string sql)
        {
            ...
            try
            {
                DbDataReader reader = base._getReader<OdbcCommand>(ref sql);
                dt.Load(reader);
                reader.Dispose();
            }
            catch (Exception ex)
        ...
        public override int ExecuteNonQuery(string sqlCommand, CommandType cmdType)
        {
            ...
            try
            {
                OdbcCommand cmd = (OdbcCommand)getCommand(ref sqlCommand, cmdType);
        ...
        public override int ExecuteNonQuery(string sql, CommandType cmdType, ParameterEngine param)
        {
            ...
            try
            {
                OdbcCommand cmd = (OdbcCommand)this.GenerateCommand(sql, cmdType, param);
